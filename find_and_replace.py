        ...
        for line in f:
            ...
            if match_indices:
                ...
                if inplace:
                    ...
                    #print("to_replace_with:", to_replace_with)
                    #print("new_match_indices:", new_match_indices)
                    print(colored_string_from_match_indices(new_line, new_match_indices, GREEN), end='')
            elif inplace:
                print(line, end='')
